...
/**
 * {@link CheckpointCoordinator} components in {@link HighAvailabilityMode#FILESYSTEM}.
 */
public class FileSystemCheckpointRecoveryFactory implements CheckpointRecoveryFactory {
	...
	public FileSystemCheckpointRecoveryFactory(
		...
		FileSystem fs,
		Executor executor) {
		this.fileSystemHARootPath = checkNotNull(fileSystemHARootPath, "FileSystemHARootPath");
