...
/**
 * Entry point for a Kubernetes per-job cluster.
 */
public class KubernetesJobClusterEntrypoint extends JobClusterEntrypoint {
	...
	// ------------------------------------------------------------------------
	//  The executable entry point for the Flink JobManager Process
	...
	public static void main(String[] args) {
		...
		final ClusterEntrypoint kubernetesJobClusterEntrypoint = new KubernetesJobClusterEntrypoint(
			KubernetesEntrypointUtils.loadConfiguration());
		ClusterEntrypoint.runClusterEntrypoint(kubernetesJobClusterEntrypoint);
	}
}
